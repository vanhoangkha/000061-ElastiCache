...
### Create a cluster (cluster mode enable)

1. Create a python file named ClusterModeEnabled.py
2. Copy the following program and paste it into the file named ClusterModeEnabled.py.
...
```
python "file path ClusterModeEnabled.py"

```

### Create a cluster (cluster mode enable) with TLS and RBAC
...
1. Create a python file named ClusterModeEnabledWithRBAC.py

2. Copy the following program and paste it into the file named ClusterModeEnabledWithRBAC.py.
...
```
python "file path ClusterModeEnabledWithRBAC.py"
